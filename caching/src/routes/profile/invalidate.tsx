...
// Mock Database specifically for Demo 2
...
export const Route = createFileRoute("/profile/invalidate")({
  staleTime: 60_000,
...
function RouteComponent() {
  ...
  const handleUpdate = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Invalidate the cache to immediately force a fresh loader execution
